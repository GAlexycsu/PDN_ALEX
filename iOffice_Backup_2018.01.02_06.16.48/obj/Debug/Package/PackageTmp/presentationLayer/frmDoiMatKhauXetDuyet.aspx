<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmDoiMatKhauXetDuyet.aspx.cs" Inherits="iOffice.presentationLayer.frmDoiMatKhauXetDuyet" %>
        ...
        <div style="width:50%; height:101px; margin-top:50px; text-align: left;" >
         <%--   <p style="width:150px"> Nhập thông tin :</p>--%>
            ...
            <table>
                <tr>
                    <td>
                        <asp:Button ID="btnChangePass" runat="server" BackColor="#F0CCFF" ForeColor="Blue" Text="同意" OnClick="btnChangePass_Click" /></td>
                    <td>
                        <asp:Button ID="btnHuy" runat="server" Text="删除" BackColor="#F0CCFF" ForeColor="Blue" OnClick="btnHuy_Click" />
                    </td>
                </tr>
                 <tr>
                    <td>
