<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMater/MyDocusND.Master" AutoEventWireup="true" CodeBehind="ChiTietPhieuTraVeChuaDich1.aspx.cs" Inherits="iOffice.presentationLayer.NguoiDich.ChiTietPhieuTraVeChuaDich1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        ...
        <div class="button-wrap" style="width:1000px;text-align:center">
            <asp:Button ID="btnLuu" runat="server" CssClass="button save" BackColor="#F0CCFF" ForeColor="Blue" Text="" OnClick="btnLuu_Click" Width="103px" /></div>
    </div>
