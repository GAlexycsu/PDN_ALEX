<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMater/MyDocus.Master" AutoEventWireup="true" CodeBehind="chitietphieugui2.aspx.cs" Inherits="iOffice.presentationLayer.ApproveUser.chitietphieudich2" %>
...
<table border="0" cellpadding="0" style="border-left: 1px solid black; border-right: 1px solid black; border-bottom: 1px solid black; border-collapse: collapse; width:1070px; float:left; border-top-style: hidden; border-top-color: inherit; border-top-width: medium;"  >
	<tbody>
		<tr>
...
<HeaderStyle BackColor="Tomato" CssClass="FixedHeader"></HeaderStyle>
  ...
  <div id="divUpload2" runat="server" style="text-align:center;margin-left:150px">
        ...
        <br />
        <div class="button-wrap" style="width:945px; float:none;text-align:center">
            <asp:Button ID="btnback" runat="server" Text="Back" CssClass="button Cancel" OnClick="btnback_Click" BackColor="#F0CCFF" ForeColor="Blue" Width="98px" />&nbsp;&nbsp;
            <asp:Button ID="btnPrint" runat="server" Text="Print" CssClass="button print" OnClientClick = "return PrintPanel();" BackColor="#F0CCFF" ForeColor="Blue" Height="22px" Width="79px" />&nbsp;&nbsp;&nbsp <asp:Button ID="btnHuy" runat="server" Text="" OnClick="btnHuy_Click" Width="197px" CssClass="button delete" BackColor="#CCFFFF" ForeColor="Blue" /></div> 
     <div style="display:none">
