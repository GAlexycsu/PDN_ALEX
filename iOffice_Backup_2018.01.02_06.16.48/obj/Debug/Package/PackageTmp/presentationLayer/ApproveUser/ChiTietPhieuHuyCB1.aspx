<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMater/MyDocus.Master" AutoEventWireup="true" CodeBehind="ChiTietPhieuHuyCB1.aspx.cs" Inherits="iOffice.presentationLayer.ApproveUser.ChiTietPhieuHuyCB1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <tr>
    ...
    <div class="button-wrap" style="width:800px;text-align:center">
        ...
        <asp:Button ID="btnLuu" runat="server" BackColor="#F0CCFF" ForeColor="Blue" CssClass="button save" Text="Lưu Và Chuyển Tới Người Duyệt Phiếu" Width="242px" OnClick="btnLuu_Click" /> &nbsp;  &nbsp;
         <asp:Button ID="btnGuiNguoiDich" runat="server" BackColor="#F0CCFF" CssClass="button Translate" ForeColor="Blue"  Text="Gửi Người Dịch" OnClick="btnGuiNguoiDich_Click" Width="139px" />
    </div>
