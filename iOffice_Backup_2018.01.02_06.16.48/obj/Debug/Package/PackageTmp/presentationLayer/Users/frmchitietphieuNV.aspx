<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMater/MyDocus.Master" AutoEventWireup="true" CodeBehind="frmchitietphieuNV.aspx.cs" Inherits="iOffice.presentationLayer.Users.frmchitietphieuNV" %>
...
<table border="0" cellpadding="0" cellspacing="0" style="width:1070px">
 ...
 <div id="divComment" runat="server" style="width:1000px">
     ...
     <p style="width:800px;margin-left:150px">
              <asp:Button ID="btnHideComment" runat="server" Text="Hide Comment" BackColor="#F0CCFF" ForeColor="Blue" OnClick="btnHideComment_Click" style="height: 26px" /></p>
 </div>
    </asp:Panel>
   
    <div id="divUpload2" runat="server" style="width:99%">
    ...
    <div class="button-wrap" style="width:1000px; text-align:center">
        <asp:Button ID="Button1" runat="server" BackColor="#F0CCFF"  ForeColor="Blue" CssClass="button Cancel" OnClick="Button1_Click" Text="Button" Width="83px" />&nbsp;&nbsp;  
         <asp:Button ID="btnPrint" runat="server" BackColor="#F0CCFF" ForeColor="Blue" CssClass="button print" Text="Print" OnClientClick = "return PrintPanel();" />
    </div>
    <div style="display:none">
