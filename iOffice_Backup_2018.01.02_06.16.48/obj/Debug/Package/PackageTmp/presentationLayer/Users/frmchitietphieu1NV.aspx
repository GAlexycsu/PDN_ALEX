<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMater/MyDocus.Master" AutoEventWireup="true" CodeBehind="frmchitietphieu1NV.aspx.cs" Inherits="iOffice.presentationLayer.Users.frmchitietphieu1NV" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <tr>
    ...
    <tr>
         <td style="text-align:left; " id="IDlyDo" runat="server">
...
<table border="0" cellpadding="0" style="border-left: 1px solid black; border-right: 1px solid black; border-bottom: 1px solid black; border-collapse: collapse; width:1070px; float:left; border-top-style: hidden; border-top-color: inherit; border-top-width: medium;">
 ...
 <div id="divComment" runat="server" style="width:1000px">
    ...
    <div class="button-wrap" style="width:1000px; text-align:center">
         <asp:Button ID="Button1" runat="server" BackColor="#F0CCFF" CssClass="button Cancel" ForeColor="Blue" Text="" OnClick="Button1_Click" Width="89px" />
         &nbsp;&nbsp;
         <asp:Button ID="btnPrint" runat="server" BackColor="#F0CCFF" ForeColor="Blue" CssClass="button print" Text="Print" OnClientClick = "return PrintPanel();" Width="61px" />
    </div>
    <div style="display:none">
