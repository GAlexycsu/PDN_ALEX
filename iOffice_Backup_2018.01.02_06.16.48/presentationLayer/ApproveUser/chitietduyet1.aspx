<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMater/Site1.Master" AutoEventWireup="true" CodeBehind="chitietduyet1.aspx.cs" Inherits="iOffice.presentationLayer.ApproveUser.chitietduyet1" %>
    ...
    <tr>
        <td class="auto-style2" style="text-align:left">
           Nội dung 内容:&nbsp;&nbsp; 
            ...
            <div style="overflow:hidden; width:1038px">
...
<HeaderStyle BackColor="Tomato" CssClass="FixedHeader"></HeaderStyle>
 ...
 <br />
   <div class="button-wrap" style="width:1000px; text-align:center">
       <asp:Button ID="Button1" runat="server" Text="Button" CssClass="button Cancel" OnClick="Button1_Click" BackColor="#F0CCFF" ForeColor="Blue" Width="100px" />&nbsp;&nbsp;
        <asp:Button ID="btnKhoiPhuc" runat="server" CssClass="button save" Text="Sửa phiếu đã không được duyệt để gửi lại" OnClick="btnKhoiPhuc_Click" BackColor="#F0CCFF" ForeColor="Blue"/>&nbsp;&nbsp;
       <asp:Button ID="btnPrint" runat="server" CssClass="button print" Text="Print" OnClientClick = "return PrintPanel();" BackColor="#F0CCFF" ForeColor="Blue" Width="93px" />
   </div>
    <div style="display:none">
