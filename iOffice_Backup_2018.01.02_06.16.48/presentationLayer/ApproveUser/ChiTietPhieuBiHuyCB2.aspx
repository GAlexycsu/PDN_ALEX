<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMater/MyDocus.Master" AutoEventWireup="true" CodeBehind="ChiTietPhieuBiHuyCB2.aspx.cs" Inherits="iOffice.presentationLayer.ApproveUser.ChiTietPhieuBiHuyCB2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="button-wrap" style="width:800px;text-align:center">
        <asp:Button ID="btnBack" runat="server" BackColor="#F0CCFF" CssClass="button Cancel" ForeColor="Blue" Text="Back" OnClick="btnBack_Click" />  &nbsp;  &nbsp; 
       
        <asp:Button ID="btnEdit" runat="server" BackColor="#F0CCFF" CssClass="button edit" ForeColor="Blue" Text="Sửa" Width="101px" OnClick="btnEdit_Click" /> &nbsp;  &nbsp; 
        <asp:Button ID="btnLuu" runat="server" BackColor="#F0CCFF" ForeColor="Blue" CssClass="button save" ValidationGroup="groupThem" Text="Lưu Và Chuyển Tới Người Duyệt Phiếu" Width="235px" OnClick="btnLuu_Click" />&nbsp;  &nbsp;
        <asp:Button ID="btnGuiNguoiDich" runat="server" BackColor="#F0CCFF" CssClass="button Translate" ForeColor="Blue"  Text="Gửi Người Dịch" OnClick="btnGuiNguoiDich_Click" Width="142px" />
    </div>
