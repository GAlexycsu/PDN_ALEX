<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMater/MyDocus.Master" AutoEventWireup="true" CodeBehind="frmChiTietPhieuChuaDichNV.aspx.cs" Inherits="iOffice.presentationLayer.Users.frmChiTietPhieuChuaDichNV" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <tr>
    ...
    <div  class="button-wrap" style="width:1000px;text-align:center">
        <asp:Button ID="Button1" runat="server" BackColor="#F0CCFF" CssClass="button Cancel" ForeColor="Blue" Text="Button" OnClick="Button1_Click" Width="111px" />
    </div>
    </div>
</asp:Content>
