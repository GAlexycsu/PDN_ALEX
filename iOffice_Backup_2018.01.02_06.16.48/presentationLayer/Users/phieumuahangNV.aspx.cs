...
{
    public partial class phieumuahangNV : LanguegeBus
    {
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            string maphieu = Session["maphieu"].ToString();
            string macongty = Session["congty"].ToString();
            DataTable dt = dal.KiemTraSoPhieuNoSize(macongty, maphieu);
            if (dt.Rows.Count > 0)
            {
                lblDDBH.Visible = false;
                txtDDBH.Visible = false;
            }
            else
            {
                lblDDBH.Visible = true;
                txtDDBH.Visible = true;
            }
        ...
        protected void btnPrint_Click(object sender, EventArgs e)
        {
           // GridView1.AllowPaging = false;
            gridComment.Columns[9].Visible = false;
            btnHideComment.Visible = false;
            btnShowComment.Visible = false;
           // this.HienThi();
