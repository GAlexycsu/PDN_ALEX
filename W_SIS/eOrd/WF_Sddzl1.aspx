<%@ Page Language="C#" AutoEventWireup="true"   MasterPageFile="~/Gui/MasterPage/Site.master" CodeFile="WF_Sddzl1.cs" Inherits="WF_Sddzl1" %>
    ...
    <center>        
     ...
     <div>
                <table style="width: 104px">
                    ...
                    <td>
                       <asp:TextBox ID="txtID" runat="server" Width="131px"  ></asp:TextBox>
                    </td>
                </tr>                    
                <tr>
                <td class="auto-style1">
