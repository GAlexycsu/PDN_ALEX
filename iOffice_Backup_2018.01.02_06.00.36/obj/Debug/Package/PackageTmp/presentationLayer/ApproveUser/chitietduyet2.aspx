<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMater/Site1.Master" AutoEventWireup="true" CodeBehind="chitietduyet2.aspx.cs" Inherits="iOffice.presentationLayer.ApproveUser.chitietduyet2" %>
 ...
 <div id="divComment" runat="server" style="width:1000px">
     <asp:GridView ID="gridComment" runat="server" AutoGenerateColumns="False" OnRowCancelingEdit="gridComment_RowCancelingEdit" OnRowEditing="gridComment_RowEditing" OnRowUpdating="gridComment_RowUpdating">
         <Columns>
             ...
             <asp:TemplateField>
                 <ItemTemplate>
                     <asp:LinkButton ID="linkEditComment" runat="server" Text="" CommandName="Edit"><img src="../../Content/Icon/download.png" /> Answer</asp:LinkButton>
                 </ItemTemplate>
                 <EditItemTemplate>
...
<HeaderStyle BackColor="Tomato" CssClass="FixedHeader"></HeaderStyle>
    ...
    <div class="button-wrap" style="width:1000px;text-align:center">
        <asp:Button ID="Button1" runat="server" Text="Button" CssClass="button Cancel" OnClick="Button1_Click" Width="109px" BackColor="#F0CCFF" ForeColor="Blue" Height="18px" />
        &nbsp;&nbsp;
        <asp:Button ID="btnKhoiPhuc" runat="server" Text="Button" CssClass="button Restore" OnClick="btnKhoiPhuc_Click" Width="163px" BackColor="#F0CCFF" ForeColor="Blue"/>
         &nbsp;&nbsp;
         <asp:Button ID="btnPrint" runat="server" Text="Print" CssClass="button print" OnClientClick = "return PrintPanel();" Width="109px" BackColor="#F0CCFF" ForeColor="Blue" />
    </div>
