<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMater/MyDocus.Master" AutoEventWireup="true" CodeBehind="frmchitietphieumuahangNV.aspx.cs" Inherits="iOffice.presentationLayer.Users.frmchitietphieumuahangNV" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
         <asp:Panel ID="pnlContents" runat="server" style="border-style: solid; border-color: inherit; border-width:1px; margin-left:20px" Width="98%">
   ...
   <table style="float:left;width:98%; border: 1px solid black;border-collapse: collapse; margin-bottom:-1px;" >
  ...
  <div style="width:98%; float:left">
             <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False" style="margin-right: 0px">
               <Columns>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-left: 1px solid black; border-right: 1px solid black; border-bottom: 1px solid black; border-collapse: collapse;width:98%; float:left; border-top-style: hidden; border-top-color: inherit; border-top-width: medium;">
	<tbody>
		<tr>
		...
		<tr>
			<td style="width:106px;height:41px;border: 1px solid black; border-collapse: collapse;">
				<p>
    ...
    <div id="divUpload2" runat="server" style="text-align:center;margin-left:150px; width: 98%;">
