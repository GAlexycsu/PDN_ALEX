...
{
    public partial class chitietphieudich2 : System.Web.UI.Page
    {
        int STT = 1;
        ...
        private void HienThi()
        {
            ...
            DataTable dt = dap.TimPhieuTheoMaNguoiTao(maphieu, macongty, nguoiduyet);
            if (dt.Rows.Count>0)
            {
                ...
                BDepartment timbophan = BDepartmentDAO.TimMaDonVi(madonvi, macongty);
                Busers2 users = UserBUS.TimNhanVienTheoMa(nguoiduyet, macongty);
                Abcon lydokhongduyet = AbconDAO.LayPhieuKhongDuyetTheoPhieu(timbophan.ID, maloaiphieu, macongty, maphieu);
