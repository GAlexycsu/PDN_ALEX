<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMater/MyDocus.Master" AutoEventWireup="true" CodeBehind="phieumuahang.aspx.cs" Inherits="iOffice.presentationLayer.ApproveUser.phieumuahang" %>
   ...
   <tr>
    ...
    <table style="float:left;width:1070px; border: 1px solid black;border-collapse: collapse; margin-bottom:-1px;" >
           <tr style="width:870px;">
              ...
              <td style="border: 1px solid black;border-collapse: collapse; text-align:center" class="auto-style9">
...
<HeaderStyle BackColor="Tomato" CssClass="FixedHeader"></HeaderStyle>
    ...
    <div class="button-wrap" style="width:1024px; text-align:center; float:none">
          <asp:Button ID="Button1" runat="server" BackColor="#F0CCFF" ForeColor="Blue"  CssClass="button Cancel" Text="Tro ve" OnClick="Button1_Click1" Width="168px" />
         &nbsp;&nbsp;
         <asp:Button ID="btnPrint" runat="server" BackColor="#F0CCFF" ForeColor="Blue" CssClass="button print" Text="Print" OnClientClick = "return PrintPanel();" Width="89px" />
    </div>
     <div style="display:none">
