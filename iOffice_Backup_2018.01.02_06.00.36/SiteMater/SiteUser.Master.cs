...
namespace iOffice.SiteMater
{
    public partial class SiteUser : System.Web.UI.MasterPage
    {
        ...
        public void GanNgonNguVaoConTrol()
        {
            ...
            ida.Text = hasLanguege["ida"].ToString();
            //idb.Text = hasLanguege["idb"].ToString();
            idc.Text = hasLanguege["idc"].ToString();
            idd.Text = hasLanguege["idd"].ToString();
            ide.Text = hasLanguege["ide"].ToString();
            ...
            HyperLink12.Text =hasLanguege["HyperLink12"].ToString();
