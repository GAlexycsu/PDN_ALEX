<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMater/MyDocusND.Master" AutoEventWireup="true" CodeBehind="phieumuahangND.aspx.cs" Inherits="iOffice.presentationLayer.NguoiDich.phieumuahangND" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
       <asp:Panel ID="pnlContents" runat="server" Width="1072px">
...
<table border="0" cellpadding="0" cellspacing="0" style="width:1070px">
    ...
    <p style="width:1075px;text-align:center">
        <asp:Button ID="btnKhoiPhuc" runat="server" Text="Sửa phiếu đã không được duyệt để gửi lại" OnClick="btnKhoiPhuc_Click" />&nbsp;&nbsp;
