<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMater/MyDocusND.Master" AutoEventWireup="true" CodeBehind="chitietphieugui1ND.aspx.cs" Inherits="iOffice.presentationLayer.NguoiDich.chitietphieugui1ND" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <asp:Panel ID="pnlContents" runat="server" Width="1070px">
        ...
        <tr>
            <td class="auto-style10" style="text-align:left"  ><asp:Label ID="lbCty" runat="server" Text="Công ty TNHH Tỷ Hùng 億 雄 責 任 有 限 公 司"></asp:Label>
                <asp:Label ID="lbSoPhieu" runat="server" Text="" style="float:right"></asp:Label>
            </td>
        </tr>
      <tr>
          <td class="auto-style10" style="text-align:center"> <asp:Label ID="lbLoaiPhieu" runat="server" Text="" BorderColor="Red"></asp:Label>
     ...
     <tr>
         <td class="auto-style9" style="text-align:left; "><asp:Label ID="Label3" runat="server" Text="Trình ban lảnh đạo Cty TNHH Tỷ Hùng 呈亿雄公司主管部"></asp:Label> </td>
     </tr>
     <tr>
         <td class="auto-style10" style="text-align:left;margin:10px">Đơn vị đề nghị 提议单位 : <asp:Label ID="lbBoPhan" runat="server" Text=""></asp:Label> </td>
     </tr>
    <tr>
     ...
     <tr>
        <td style="text-align:left;" class="auto-style10">Nội dung dịch 翻译内容 :&nbsp;&nbsp; 
            <div style="overflow:hidden; width:800px">
...
<table border="0" cellpadding="0" cellspacing="0" style="width: 1070px">
	<tbody>
		...
		<tr>
         ...
         <p style="width:1075px;text-align:center">
            <asp:Button ID="btnPrint" runat="server" BackColor="#F0CCFF" ForeColor="Blue" Text="Print" OnClientClick = "return PrintPanel();" />&nbsp;</p> 
</asp:Content>
