...
{
    public partial class ExportProject : System.Web.UI.Page
    {
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            if (txtFromDate.Text.Trim() != "" && txtToDate.Text.Trim() != "" && UserID != null)
            {
                ...
                Response.Redirect("WF_ReportT.aspx?Type=BaoCaoProject&UserID=" + UserID + "&FromDate=" + txtFromDate.Text.Trim() + "&ToDate=" + txtToDate.Text.Trim());
            }
        }
