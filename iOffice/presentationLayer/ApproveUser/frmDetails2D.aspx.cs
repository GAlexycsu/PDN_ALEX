...
{
    public partial class frmDetails2D : LanguegeBus
    {
        string capduyet;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (danhsachphieu.Count == 0)
                {
                    ...
                    andi.Visible = false;
                    andi1.Visible = false;
                    chunhiem.Style.Add("with", "2% !important");
                    chunhiem1.Style.Add("with", "2% !important");
                    andi.Style.Add("with", "2% !important");
                    andi1.Style.Add("with", "2% !important");
                }
                else
                {
        ...
        private void HienThi()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                string dinhdang = dt.Rows[0]["CFMDate0"].ToString();// phieu.CFMDate0.ToString();
