<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMater/MyDocus.Master" AutoEventWireup="true" CodeBehind="frmSuaphieumuahangNV.aspx.cs" Inherits="iOffice.presentationLayer.Users.frmSuaphieumuahangNV" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="width:1100px; float:left">
         <table style="float:left; width: 1100px;" id="tablePMH" runat="server">
               ...
               <tr style="text-align:center"> 
                   ...
                   <td  >
                       <asp:TextBox ID="txtAutoComplete"  runat="server" ClientIDMode="Static" Class="autosuggest" TextMode="MultiLine" Width="439px" Height="31px" OnTextChanged="txtAutoComplete_TextChanged" ></asp:TextBox>
                   ...
                   <td class="button-wrap">
                       <asp:Button ID="Button1" runat="server" BackColor="#F0CCFF" CssClass="button save" ForeColor="Blue" Text="Save" ValidationGroup ="groupthemmoi" OnClick="Button1_Click1" Height="35px" Width="59px" /></td>
               </tr>
               <tr>
                   <td>
   ...
   <br />
    <div class="button-wrap" style="text-align:center"> 
        <asp:Button ID="btnTroLai" runat="server" CssClass="button Cancel" BackColor="#F0CCFF" ForeColor="Blue" Text="Trở lại/脊背" OnClick="btnTroLai_Click"  Width="103px" />
&nbsp; <asp:Button ID="btnComplete" runat="server" CssClass="button Complete" BackColor="#F0CCFF" ForeColor="Blue" Text="Hoàn tất / 完毕" OnClick="btnComplete_Click" Width="116px" /></div>
