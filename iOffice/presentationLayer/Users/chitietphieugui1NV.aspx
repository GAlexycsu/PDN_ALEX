<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMater/MyDocus.Master" AutoEventWireup="true" CodeBehind="chitietphieugui1NV.aspx.cs" Inherits="iOffice.presentationLayer.ApproveUser.chitietphieugui1NV" %>
...
<table border="0" cellpadding="0" cellspacing="0" style="width:1070px">
   ...
   <br />
          <p style="width:800px;margin-left:150px">
              <asp:Button ID="btnShowComment" runat="server" BackColor="#F0CCFF" ForeColor="Blue" Text="Show Coment" OnClick="btnShowComment_Click" />
 ...
 <div id="divComment" runat="server" style="width:1000px">
     <asp:GridView ID="gridComment" runat="server" AutoGenerateColumns="False" OnRowCancelingEdit="gridComment_RowCancelingEdit" OnRowEditing="gridComment_RowEditing" OnRowUpdating="gridComment_RowUpdating">
         <Columns>
             ...
             <asp:TemplateField>
                 <ItemTemplate>
                     <asp:LinkButton ID="linkEditComment" runat="server" Text="Answer" CommandName="Edit"><img src="../../Content/menu/exit-button.png" /> Answer </asp:LinkButton>
                 </ItemTemplate>
                 <EditItemTemplate>
    ...
    <br />
         <div class="button-wrap" style="width:1021px; float:none;text-align:center;margin-left:20px" >
             <asp:Button ID="btnBack" runat="server" BackColor="#F0CCFF" CssClass="button Cancel" ForeColor="Blue" Text="Back" OnClick="btnBack_Click" Width="65px" />
            <asp:Button ID="btnPrint" runat="server" BackColor="#F0CCFF" CssClass="button print" ForeColor="Blue" Text="Print" OnClientClick = "return PrintPanel();" Width="68px" />&nbsp;&nbsp
              <asp:Button ID="btnHuy" runat="server" BackColor="#F0CCFF" ForeColor="Blue" CssClass="button delete" Text="" OnClick="btnHuy_Click" Width="147px" /></div> 
