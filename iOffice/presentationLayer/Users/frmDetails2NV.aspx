<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMater/MyDocus.Master" AutoEventWireup="true" CodeBehind="frmDetails2NV.aspx.cs" Inherits="iOffice.presentationLayer.Users.frmDetails2NV" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <div id="divComment" runat="server" style="width:1000px; margin-left:20px">
    ...
    <div class="button-wrap" style="width:1024px; text-align:center">
        <asp:Button ID="Button1" runat="server" BackColor="#F0CCFF" ForeColor="Blue" CssClass="button Cancel" Text="Button" OnClick="Button1_Click" Width="76px" />&nbsp;&nbsp;
        ...
        <asp:Button ID="btnPrint" runat="server" BackColor="#F0CCFF" ForeColor="Blue" CssClass="button print"  Text="Print" OnClientClick = "return PrintPanel();" Width="74px" />
    </div>
     <div style="display:none">
