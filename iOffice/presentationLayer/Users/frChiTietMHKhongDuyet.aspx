<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMater/MyDocus.Master" AutoEventWireup="true" CodeBehind="frChiTietMHKhongDuyet.aspx.cs" Inherits="iOffice.presentationLayer.Users.frChiTietMHKhongDuyet" %>
 ...
 <div id="divComment" runat="server" style="width:1000px">
     <asp:GridView ID="gridComment" runat="server" AutoGenerateColumns="False" OnRowCancelingEdit="gridComment_RowCancelingEdit" OnRowEditing="gridComment_RowEditing" OnRowUpdating="gridComment_RowUpdating">
         <Columns>
             ...
             <asp:TemplateField>
                 <ItemTemplate>
                     <asp:LinkButton ID="linkEditComment" runat="server" Text="" CommandName="Edit"><img src="../../Content/img/edit16x16.png" />Answer </asp:LinkButton>
                 </ItemTemplate>
                 <EditItemTemplate>
     ...
     <br />
    <div class="button-wrap" id="idButton" runat="server" style="width:1020px; text-align:center">
         <asp:Button ID="Button1" runat="server" CssClass="button Cancel" Text="Button" ToolTip=""  OnClick="Button1_Click" Width="99px" />  &nbsp;&nbsp; 
        <asp:Button ID="btnKhoiPhuc" runat="server" Text="Button" CssClass="button Restore" OnClick="btnKhoiPhuc_Click" Width="107px" /> &nbsp;&nbsp; 
        <asp:Button ID="btnPrint" runat="server" Text="Print" CssClass="button print" OnClientClick = "return PrintPanel();" Width="127px" />
    &nbsp;
    ...
    <asp:Panel ID="idPanelExport" runat="server" >
          <div style="width:600px;height:400px; margin-left:250px;margin-top:100px">
             ...
             <p style="width: 390px; text-align:center">
                 <asp:Button ID="btnPrintPMH" runat="server" BackColor="#F0CCFF" ForeColor="Blue" Text="Export" OnClick="btnPrintPMH_Click" />
             </p>
         </div>
    </asp:Panel>
    <div style="display:none">
