<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMater/Site1.Master" AutoEventWireup="true" CodeBehind="chitietphieumuahang.aspx.cs" Inherits="iOffice.presentationLayer.ApproveUser.chitietphieumuahang" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="margin-left:20px">
       <asp:Panel ID="pnlContents" runat="server" style="border-style: solid; border-color: inherit; border-width:1px;" Width="1070px">
    ...
    <table style="float:left;width:1070px; border: 1px solid black;border-collapse: collapse; margin-bottom:-1px;" >
           <tr style="width:1100px;">
              ...
              <td style="border: 1px solid black;border-collapse: collapse; text-align:center" class="auto-style1">
...
<table border="0" cellpadding="0" style="border: 1px solid black; border-collapse: collapse; width:1070px ; float:left"  >
	<tbody>
		<tr>
...
<HeaderStyle BackColor="Tomato" CssClass="FixedHeader"></HeaderStyle>
    ...
    <br />
        <div class="button-wrap" style="width:1095px; text-align:center">
            <asp:Button ID="btnHuy" runat="server" CssClass="button Cancel" OnClick="btnHuy_Click" Text="删除" Width="154px" BackColor="#F0CCFF" ForeColor="Blue" /> &nbsp;

         
     <asp:Button ID="btnContinues" runat="server" Text="继续" CssClass ="button Continue" OnClick="btnContinues_Click" Width="89px" BackColor="#F0CCFF" ForeColor="Blue" />
