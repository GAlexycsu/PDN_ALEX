<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMater/MyDocus.Master" AutoEventWireup="true" CodeBehind="frmDetailsNV.aspx.cs" Inherits="iOffice.presentationLayer.Users.frmDetailsNV" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../../Scripts/jquery.min.js"></script>
    <script src="../../Scripts/jquery-ui.min.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="border-style: solid; border-color: inherit; width:1102px; border-width:1px; margin-left:15px">
        ...
        <table style="width: 1070px;  overflow:hidden">
                <tr>
                   ...
                   <asp:Label ID="Label1Sophieucu" runat="server" Text="Số phiếu cũ 旧的单号:"></asp:Label> <asp:Label ID="Label2cophieucu" runat="server" Text=""></asp:Label></td></tr>
              <tr>
                  <td  style="text-align:center"> <asp:Label ID="lbLoaiPhieu" runat="server" Text="" ></asp:Label></td>
              </tr>
             <tr>
                 <td ><asp:Label ID="Label3" runat="server" Text="Trình ban lãnh đạo công ty TNHH Tỷ Hùng 呈亿雄公司主管部"></asp:Label> 
            ...
            <tr>
                <td style="text-align:left;">
                   Nội dung 内容:&nbsp;&nbsp; 
                    ...
                    <div style="overflow:hidden; width:1030px">
            ...
            <tr>
                <td style="text-align:left;">Nội dung dịch 翻译内容 :&nbsp;&nbsp; 
                    <div style="overflow:hidden; width:1028px">
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="width:1070px;">
	        <tbody>
		        ...
		        <tr>
			        ...
			        <td style="width:118px;height:41px;">
				        <p>
                            <asp:Image ID="ImageLevel0" runat="server" Height="106px" Width="121px" />
					        </p>
