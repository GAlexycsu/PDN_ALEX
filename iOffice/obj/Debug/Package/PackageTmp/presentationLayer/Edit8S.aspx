<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit8S.aspx.cs" Inherits="iOffice.presentationLayer.Edit8S" %>
            ...
            <table >
               ...
               <tr>
                ...
                <tr  >
                    ...
                    <td >
                           <asp:TextBox ID="txtMemoVN" runat="server" MaxLength="200" Width="900px" Rows="4" style="margin-bottom: 0px" ></asp:TextBox>
            ...
            <div class="left" style="float:left; width:15%; text-align:left;" >
             ...
             <asp:Image ID="ImagePic2" runat="server" Class="gridViewToolTip" Width="100px" Height="100px" />
                ...
                <table>
                    ...
                    <tr>
                        <td class="auto-style2"><asp:CheckBox ID="CheckBox1" runat="server"   ToolTip="Ok then continues else 0 scrore"/> </td>
                        <td class="auto-style2">OK</td>
                    </tr>
                    <tr>
                        <td class="button-wrap"> <asp:Button ID="Button1" runat="server" Text="Save"  CssClass="button save"  Width="165px" BackColor="#F0CCFF"  ForeColor="Blue"  ValidationGroup="groupThem" OnClick="Button1_Click" /></td>
                        <td class="button-wrap">
