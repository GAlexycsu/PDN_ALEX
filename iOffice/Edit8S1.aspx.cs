...
namespace iOffice
{
    public partial class Edit8S1 : LanguegeBus
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (Sua != null)
                {
                    DropDown.SelectedValue = Sitemno;
        ...
        public void HienThiDanhSachTheoID(int ID)
        {
            ...
            if (ngonngu == "lbl_VN")
            {
                DataTable dt = dalType.LayDanhSachS8TheoIDVN(ID);
                if (dt.Rows.Count > 0)
                {
            ...
            {
                DataTable dt = dalType.LayDanhSachS8TheoIDTW(ID);
                if (dt.Rows.Count > 0)
                {
                    txtMemoVN.Text = dt.Rows[0]["QCmemo"].ToString();
                    txtScore1.Text = dt.Rows[0]["sub_score"].ToString();
            ...
            {
                DataTable dt = dalType.LayDanhSachS8TheoIDEN(ID);
                if (dt.Rows.Count > 0)
                {
                    txtMemoVN.Text = dt.Rows[0]["QCmemo"].ToString();
                    txtScore1.Text = dt.Rows[0]["sub_score"].ToString();
